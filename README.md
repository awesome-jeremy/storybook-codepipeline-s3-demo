This repo is configuring a Storybook project and integrate it with AWS CodePipeline, so whenever you push new code, it will auto trigger new build and deploy to the S3 website.
